...
class CompassPresenterImpl : CompassPresenter(), MainView.onLocationRequest {
    ...
    override fun onlocationReturn(latitude: Double, longitude: Double) {
        view?.showCurrentLocation(latitude.toString(), longitude.toString())
    }
}